...
>
  <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3">
    ...
    <nav className="hidden md:flex items-center space-x-8 text-sm font-medium">
      ...
      {user?.role && (
        <Link
          ...
          className="nav-dashboard text-neutral-800 dark:text-neutral-200 hover:text-black dark:hover:text-white transition-colors"
        >
          Dashboard
        </Link>
      )}
    ...
    {/* Desktop right section: ModeToggle + Profile/Login */}
      ...
      {!user ? (
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-44 bg-white dark:bg-black border border-neutral-200 dark:border-neutral-800">
            ...
            {user.role === "RIDER" && (
              <DropdownMenuItem asChild>
                <Link to="/become-driver">Be a Driver</Link>
              </DropdownMenuItem>
            )}
    ...
    <div className="flex md:hidden items-center gap-2">
      <ModeToggle /> {/* Added ModeToggle beside hamburger */}
            ...
            {user && (
              <>
                <Link
                  ...
                  onClick={() => setOpen(false)}
                  className="nav-dashboard text-neutral-800 dark:text-neutral-200 text-lg font-medium hover:text-black dark:hover:text-white"
                >
                  Dashboard
                </Link>
